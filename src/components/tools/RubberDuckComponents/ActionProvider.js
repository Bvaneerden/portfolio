...
// console.log()
    ...
    //   const responses = ['That is very interesting. Tell me more', 'That is very interesting.', 'Quack', 'Tell me more', 'did you try turning it off and on again', ' Obviously you need a cuppa', 'When is the last time you went for a walk to clear your head', 'oh really', 'hmmmm', 'This looks like great weather for a swim', 'Oh well, maybe we should get a snack', 'Could you please go into more details', 'Ok so what is it suposed to do?']
